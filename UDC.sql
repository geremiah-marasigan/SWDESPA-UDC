...
INSERT INTO `User` VALUES ('alex_reyes@dlsu.edu.ph','alex','DOCTOR','Alex','Reyes'),('charles_navarro@dlsu.edu.ph','charles','CLIENT','Charles','Navarro'),('won_suk_cho@dlsu.edu.ph','wonsuk','SECRETARY','Won Suk','Cho'),('zach_marasigan@dlsu.edu.ph','zach','DOCTOR','Zach','Marasigan');
